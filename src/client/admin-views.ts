...
export function createAdminViews(deps: AdminViewDeps) {
  ...
  const sections: Array<[SystemView, string, string]> = [
    ["settings", "Agent 设置", "Claude Code CLI 与运行策略"],
